  ...
  return (
    <section id="what-we-offer" className="relative bg-bg0 text-dark py-24 px-6 z-30 border-t border-dark/10">
      <div className="max-w-4xl mx-auto flex flex-col items-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full max-w-4xl mt-16 text-left">
          {bentoFeatures.map((feat, idx) => (
            <div
              key={idx}
              className="group relative bg-bg1/10 hover:bg-bg1/15 border border-dark/15 p-6 md:p-8 transition-all duration-300 hover:-translate-y-1.5 hover:shadow-xl flex flex-col justify-between overflow-hidden"
            >
              ...
              <div>
                <div className="text-4xl mb-4 transform transition-transform duration-300 group-hover:scale-110 group-hover:translate-x-1 inline-block">
                  {feat.icon}
                </div>
...
function DashboardShowcase() {
  ...
  return (
    <div className="w-full max-w-3xl bg-bg1 text-bg0 shadow-2xl border border-bg0/20 overflow-hidden relative">
