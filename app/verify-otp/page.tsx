...
import { ShieldCheck, ArrowLeft, ArrowRight, RotateCcw } from "lucide-react";
...
export default function VerifyOTPPage() {
  ...
  return (
    <main className="min-h-screen bg-bg0 flex flex-col">
      ...
      >
        <Link href="/verify-phone" className="flex items-center gap-2 text-bg1/70 hover:text-bg1 transition-colors">
